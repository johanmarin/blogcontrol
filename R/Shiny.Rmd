...
* *Valores: *Luego se ponen los valores que puede seleccionar el usuario, Este argumento varía según el tipo de entrada que se tenga.
...
* *Valor por defecto: *El valor por defecto es el valor que tendrá la entrada cuando se inicia la app; **value**.
* *Animación: *Este argumento permite que la entrada se pueda ejecutar de forma animada, cuando este este tiene como valor verdadero, aparece un botón de play que al accionarlo hace que los valores cambien automáticamente
